CREATE TABLE PAIS ( COD_PAIS NUMBER,
                    NOME    VARCHAR2(30));
...
FK__ESTADO FOREIGN KEY (COD_PAIS) REFERENCES PAIS (COD_PAIS);   
...
FK__CIDADE FOREIGN KEY (COD_ESTADO) REFERENCES ESTADO (COD_ESTADO);
...
FK__BAIRRO FOREIGN KEY (COD_CIDADE) REFERENCES CIDADE (COD_CIDADE); 
